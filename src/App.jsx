    ...
    <div className='d-flex justify-content-center align-items-center'style={{width:'100' ,height:'100vh'}} >
      <div className='bg-light p-5 rounded' style={{width:'500px'}}>
        ...
        <p>Calculate your Simple interest easily</p>
         <div className='mt-5 flex-column bg-warning d-flex justify-content-center align-items-center p-3'>
        ...
        <form className='mt-5'>
          <div className="mb-3">
          <TextField id="outlined-basic" value={principle || ""} name='principle' label="Principle amount" variant="outlined" onChange={(e)=> validate(e)} className='w-100' />
{!isPrinciple && 
